...
UPDATE operativos
  SET config_sorteo= '{
        "F:RE":{
            ...
            "expr_incompletitud": {
                "3":{"dominio": 3, "expr": "not(nombre) or not(sexo) or blanco(edad)"},
                "5":{"dominio": 5, "expr": "not(nombre) or not(sexo) or blanco(edad) or (edad >= 18 and not(lp))"}
            },
            "disparador": "sorteo",
            "filtro": {
        ...
        "F:RE_SUP":{
            ...
            "expr_incompletitud": {
                "3":{"dominio": 3, "expr": "not(nombre_sup) or not(sexo_sup) or blanco(edad_sup)"},
                "5":{"dominio": 5, "expr": "not(nombre_sup) or not(sexo_sup) or blanco(edad_sup)"}
            },
