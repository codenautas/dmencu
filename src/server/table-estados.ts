...
export function estados(context:TableContext):TableDefinition {
    ...
    return {
        ...
        fields:[
            ...
            {name:'visible_en_fin_campo'         , typeName:'boolean', nullable:false, defaultDbValue:'false'},
            {name:'visible_en_analisis_campo'    , typeName:'boolean', nullable:false, defaultDbValue:'false'},
            {name:'visible_en_procesamiento'     , typeName:'boolean', nullable:false, defaultDbValue:'false'},
        ],
